...
public class PerformanceTests {
    ...
    private static final String[] testFiles = {"tiny.txt","small.txt","MetaMorph.txt","Species.txt","Ulysses.txt","WarPeace.txt","Bulk.txt"};
    
    @BeforeAll
    static void openOutputFile() {
        try {
            writer = new BufferedWriter(new FileWriter(outputFileName));
            writer.append("testfile,bytes,words,unique words,time,nˆ2,n*m,lg(n*m), (n*m)*lg(n*m)");
            writer.newLine();
        } catch (IOException e) {
